    ...
    >
      ...
      <div className="flex items-center">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
          Foodie <span className="font-bold"> People</span>
        </h1>
      ...
      {/* Cart button */}
      <button
        className="bg-black text-white hidden lg:flex md:flex
      ...
      {nav ? <div className='bg-black/80 fixed w-full h-screen z-10 top-0 left-0'></div> : ''}
        ...
        <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300' }>
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl px-2 p-4">
          Foodie <span className="font-bold"> People</span>
        </h2>
        <nav>
            ...
            <li className='text-xl py-4 flex'><TbTruckDelivery size={25} className='mr-4' /> Orders</li>
                ...
                <li className='text-xl py-4 flex'><FaUserFriends size={25} className='mr-4' /> Invite Friends</li>            </ul>
        </nav>
        </div>
      </div>
  );
