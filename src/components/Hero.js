    ...
    <div className='max-w-[1640px] mx-auto p-4'>
      <div className='max-h-[500px] relative'>
        ...
        bg-black/40 flex flex-col justify-center'>
          <h1 className='px-4 text-4xl lg:text-7xl md:text-6xl sm:5xl  font-bold'>The<span className='text-orange-600'> Best</span></h1>
          <h1 className='px-4 text-4xl lg:text-7xl md:text-6xl sm:5xl font-bold'>Food<span className='text-orange-600'> Deliverd</span></h1>
        </div>
